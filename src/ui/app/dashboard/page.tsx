      ...
      <main className="relative mx-auto max-w-7xl px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="mt-3 text-white/40 text-sm">
            Your AI Insurance Adjuster dashboard — manage claims, view analytics, and configure your account.
          </p>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/[0.02] p-6 hover:border-[#3B82F6]/30 transition-all duration-300">
            ...
            <div className="relative">
              ...
              <h3 className="text-base font-semibold text-white mb-2">Claims</h3>
          ...
          {/* Profile */}
          <Link href="/profile" className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/[0.02] p-6 hover:border-[#8B5CF6]/30 transition-all duration-300">
        ...
        {profile?.role === "admin" && (
          <div className="mt-12">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <Link href="/admin/create-user" className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/[0.02] p-6 hover:border-[#3B82F6]/30 transition-all">
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-white mb-1">Create User</h3>
                    <p className="text-xs text-white/40">Add new users to the platform with email confirmation.</p>
                  </div>
                </div>
              </Link>
              <Link href="/admin/manage-users" className="group relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-white/5 to-white/[0.02] p-6 hover:border-[#8B5CF6]/30 transition-all">
                ...
                <div className="relative flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-sm font-semibold text-white mb-1">Manage Users</h3>
                    <p className="text-xs text-white/40">Search, filter, and remove users from the platform.</p>
                  </div>
                </div>
              </Link>
            </div>
